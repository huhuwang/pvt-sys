...
CREATE TABLE `common_test_case_base`  (
  ...
  `category` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_bin NULL DEFAULT NULL COMMENT '1. SIT 2.UAT 4.RT 8.PVT 16.WEB 32.IPAD',
  `category_val` int NULL DEFAULT NULL COMMENT '1. SIT 2.UAT 4.RT 8.PVT 16.WEB 32.IPAD',
...
CREATE TABLE `kv_constants`  (
  ...
  INDEX `template_idx`(`template_id` ASC) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 958 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_bin ROW_FORMAT = Dynamic;

-- ----------------------------
-- Table structure for pvt_document
-- ----------------------------
DROP TABLE IF EXISTS `pvt_document`;
CREATE TABLE `pvt_document`  (
...
) ENGINE = InnoDB AUTO_INCREMENT = 903 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_bin ROW_FORMAT = Dynamic;
